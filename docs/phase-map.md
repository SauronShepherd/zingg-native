...
| match | `SparkMatcher` | scoring, thresholding, clustering, output | contract inventory in `docs/upstream-match-link-contract.md`; shared-core implementation open |
| link | `SparkLinker` | cross-source candidate generation and scoring | source-sensitive contract in `docs/upstream-match-link-contract.md`; shared-core implementation open |
