...
| Databricks Serverless JAR task / shared Scala core | PASS (Exact + Jaccard + Jaro + 3 phases) | NOT TESTED | NOT TESTED | Real job `295665184144562`, run `262883055838342`, Spark 4.1.0; plugin loading not proven |
