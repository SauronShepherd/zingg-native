...
| Databricks Serverless Asset Bundle / shared Scala core | PASS (same narrow slice + UC-volume persistence) | NOT TESTED | NOT TESTED | Bundle job `190949869955356`, run `769411192277182`, task `291692707314471`, Spark 4.1.0; plugin loading not proven |
