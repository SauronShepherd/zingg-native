...
| Databricks Serverless JAR task / shared Scala core | PASS (Jaccard + 3 phases) | NOT TESTED | NOT TESTED | Real job `295665184144562`, run `310851442443218`, Spark 4.1.0; plugin loading not proven |
