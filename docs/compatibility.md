...
| Databricks Serverless JAR task / shared Scala core | PASS (Exact + Jaccard + Jaro + 3 phases + UC-volume persistence) | NOT TESTED | NOT TESTED | Real job `295665184144562`, run `847651604040137`, Spark 4.1.0; plugin loading not proven |
| Databricks Serverless Asset Bundle / shared Scala core | PASS (same narrow slice + UC-volume persistence) | NOT TESTED | NOT TESTED | Bundle job `190949869955356`, run `587364164966781`, task `435289637777827`, Spark 4.1.0; plugin loading not proven |
