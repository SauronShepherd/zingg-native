...
| Databricks Serverless Asset Bundle / shared Scala core | PASS (same narrow slice + UC-volume persistence) | NOT TESTED | NOT TESTED | Bundle job `190949869955356`, run `953664091738695`, Spark 4.1.0; plugin loading not proven |
