...
| Training evidence readiness | Verified prerequisite | `Core.inspectTrainingEvidence`, Classic gateway, Serverless Bundle run `587364164966781` | Five-positive/five-negative count executed on Spark 4.1.0; model fitting remains open |
...
| Databricks Serverless Asset Bundle deployment | Verified narrow slice | Bundle job `190949869955356`, run `587364164966781` | Automated publish, deploy, and run sequence completed on Serverless; managed Connect remains open |
