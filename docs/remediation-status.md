...
| Databricks Serverless Asset Bundle deployment | Verified expanded slice | Bundle job `190949869955356`, run `168088194011842` | Automated publish, deploy, and run sequence completed with shared preprocessing on Serverless; managed Connect remains open |
