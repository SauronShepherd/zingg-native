...
| Databricks Serverless shared-core JAR task | Verified narrow slice | Job `295665184144562`, run `262883055838342` | Exact/Jaccard/Jaro plus findTrainingData/label/updateLabel executed on Spark 4.1.0; Connect plugin remains open |
