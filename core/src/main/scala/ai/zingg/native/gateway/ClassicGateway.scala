...
class ClassicGateway {
  ...
  def capabilityMetadata: String = "shared-core;EXACT_SIMILARITY;JACCARD_SIMILARITY;JARO_SIMILARITY;TRIM;CASE_NORMALIZE;CLASSIC_FIND_TRAINING_DATA;CLASSIC_LABEL;CLASSIC_UPDATE_LABEL;model-artifact-schema-v1;blocking-tree-artifact-schema-v1;phase-parity-not-certified"
  ...
  def supportedPhases: Array[String] = Array("preprocess", "findTrainingData", "label", "updateLabel")
